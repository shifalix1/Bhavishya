...
_SEMANTIC_BUCKETS: dict[str, list[str]] = {
    # Analytical cluster
    "analytical":    ["analytical", "analytical thinking", "analytically rigorous", "critical thinking"],
    "analyzing":     ["analytical", "analytical thinking", "data analysis", "research methodology"],
    ...
    # Creative cluster
    "creative":      ["creative", "creative thinking", "creative problem-solving", "artistic expression"],
    "artistic":      ["artistic", "artistic expression", "aesthetic-driven", "aesthetically sensitive"],
    "drawing":       ["visual thinking", "artistic expression", "aesthetic-driven", "creative"],
    "design":        ["design thinking", "aesthetic-driven", "visual thinking", "creative problem-solving"],
    "aesthetic":     ["aesthetic-driven", "aesthetically sensitive", "visual thinking", "artistic expression"],
    "storytelling":  ["storytelling", "narrative building", "communication", "creative writing"],
    ...
    "performing":    ["performance", "artistic expression", "public speaking", "communication"],
    "art":           ["artistic expression", "aesthetic-driven", "creative", "visual thinking"],

    # Visual / spatial / building cluster
    "visual":        ["visual thinking", "3d visualization", "spatial awareness", "design thinking"],
    "spatial":       ["spatial reasoning", "3d spatial thinking", "spatial awareness", "visual thinking"],
    "building":      ["building real things", "building physical things", "technical craftsmanship", "building something new"],
    "making":        ["building real things", "technical craftsmanship", "hands-on problem solving", "making things work"],
    "doing":         ["hands-on problem solving", "building real things", "technical craftsmanship", "practical application"],
    "hands":         ["hands-on problem solving", "technical craftsmanship", "building physical things"],
    "maker":         ["building real things", "technical craftsmanship", "hands-on problem solving"],
    "builder":       ["building real things", "technical craftsmanship", "engineering mindset"],
    "coding":        ["programming", "software development", "technical craftsmanship", "logical thinking"],
    "programming":   ["programming", "software development", "logical thinking", "systems thinking"],
    "technical":     ["technical craftsmanship", "engineering mindset", "systems thinking", "analytical"],
    "engineering":   ["engineering mindset", "systems thinking", "technical craftsmanship", "building real things"],
    "output":        ["building real things", "making things work", "results-oriented"],
    "experiment":    ["scientific inquiry", "hands-on problem solving", "curiosity", "research"],
    "practical":     ["hands-on problem solving", "practical application", "technical craftsmanship"],

    # Pattern / observation / detail cluster
    "pattern":       ["pattern recognition", "analytical", "data analysis", "observational"],
    "noticing":      ["pattern recognition", "observational", "attention to detail", "analytical"],
    ...
    "communication": ["communication", "communicative", "verbal communication", "public speaking"],
    "teaching":      ["teaching", "mentoring", "communication", "knowledge sharing"],
    "explaining":    ["communication", "teaching", "simplifying complexity", "knowledge sharing"],
    ...
    "leadership":    ["leadership", "team leadership", "strategic leadership", "influence"],
    ...
    "solving":       ["problem-solving", "troubleshooting", "solutions-oriented", "analytical"],
    "problems":      ["problem-solving", "troubleshooting", "analytical", "critical thinking"],
    ...
    "independent":   ["self-directed", "entrepreneurial mindset", "autonomous", "initiative"],
    "entrepreneurial": ["entrepreneurial mindset", "risk-taking", "innovation", "self-directed"],
    "innovation":    ["innovation", "creative problem-solving", "entrepreneurial mindset"],
    "independent":   ["self-directed", "autonomous", "deep focus", "initiative"],
    "alone":         ["self-directed", "autonomous", "deep focus", "research"],

    # Values cluster
    "impact":        ["social impact", "service orientation", "community focus", "purpose-driven"],
    ...
    "curiosity":     ["curiosity", "continuous learning", "research", "analytical thinking"],
    ...
    "physical":      ["physical discipline", "athletic excellence", "hands-on problem solving"],

    # Finance / business cluster
    "finance":       ["financial analysis", "quantitative analysis", "business acumen"],
    "business":      ["business acumen", "entrepreneurial mindset", "management", "strategic thinking"],
    ...
    for i, word in enumerate(words):
        ...
        if clean not in seen_keys:
            for key in _SEMANTIC_BUCKETS:
                if len(key) > 4 and (key in clean or clean in key) and key not in seen_keys:
...
def _slim_careers(careers: list) -> list:
    ...
    """
    keep = {
        "id", "name", "category", "description_short",
        "indian_reality", "ai_disruption", "honest_reality", "parent_frame",
    }
